...
Observe que, para o algoritmo mostrado na Figura \ref{Escalonamento} seja válido, pressupõe-se que toda tarefa do algoritmo é capaz de rodar em \acrshort{CPU}. O pressuposto simplifica o primeiro passo do algoritmo, pois se a lista de \acrshort{CPU}s não estiver vazia, essa condição é automaticamente satisfeita.
